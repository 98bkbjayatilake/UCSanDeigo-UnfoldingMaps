...
public abstract class EarthquakeMarker extends CommonMarker
{
	...
	public void showTitle(PGraphics pg, float x, float y)
	{
		...
		//add my new code
		String earthquacke_name=getTitle();
		float text_width=pg.textWidth(earthquacke_name);
		int text_size=12;
		y=y+2*radius;
		
		pg.fill(255,255,255);
		pg.rect(x,y,text_width+3,text_size+3);
		
		pg.fill(0);
		pg.textSize(text_size);
		pg.text(earthquacke_name,x,y+text_size);
