...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		ellipse(25, 360, 10, 10);
		fill(color(0, 0, 255));
		ellipse(25, 410, 5, 5);
		
		fill(0, 0, 0);
		//added new code
		text("City Marker",40,112);
		text("Land Quake",35,150);
		text("Ocean Quake",35,180);
		text("Size-Magnitude",50,230);
		//new
		text("5.0+ Magnitude(Deep)", 45, 300);
		text("4.0+ Magnitude(Intermediate)", 35, 360);
		text("Below 4.0(Shallow)", 30, 410);
		         ...
		         int quackcounter=0;
		        	 ...
		        	 for(Marker marker:quakeMarkers) 
		        	 {
		        		 ...
		        		 if(eqm.isOnLand()) 
		        		 {
		        			 ...
		        			 if(country_name.equals(eqm.getStringProperty("country")))
		        			 {
		        			 quackcounter++;
		        	 ...
		        	 if(quackcounter>0) 
		        	 {
		        		totaloceanquakes=totaloceanquakes-quackcounter;
		        		System.out.println(country_name+":"+quackcounter); 
		        	 }
		        	 
		        	 
		         }
		         System.out.println("OCEAN QUACKES: "+totaloceanquakes);
	}
